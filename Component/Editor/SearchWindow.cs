...
namespace RaTweening
{
	public class SearchWindow : EditorWindow
	{
		...
		public static SearchWindow OpenWindow(Action<(int, bool)[]> onMultiSelectEndedCallback, params (object, bool)[] itemsToSelectFrom)
		{
		...
		private static SearchWindow BaseOpenWindow(Action<SearchWindow> setupRequest)
		{
